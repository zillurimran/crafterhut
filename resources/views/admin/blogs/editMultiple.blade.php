...
{{-- Title --}}
@section('title')
    {{ config('app.name') }} | {{ ucfirst($blog->title )}}'s Image Gallery
@endsection
            ...
            <div class="col-lg-8 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ ucfirst($blog->title )}}</h4>
                        @if (session('success'))
                    ...
                    <div class="card-body">
                        <p class="card-text">
                            List of {{ ucfirst($blog->title )}}'s Image Gallery
                        </p>
                        <div class="table-responsive">
                            <table id="data_table" class="table table-bordered text-center">
                                ...
                                <tbody>
                                    @foreach ($blog->getMultipleImages as $item)
                                        <tr>
                                            <td>{{ $loop->index + 1 }}</td>
                                            <td>
                                                <img src="{{ asset('uploads/blogs') }}/{{ $item->multiple_images }}" width="90" alt="multiple-image">
                                            </td>
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <form action="{{ route('delete.blogmultiple', $item->id) }}" method="POST">
                                                            {{-- Initiate Delete method --}}
                                                            
                                                            @csrf 
                                                            <a class="dropdown-item" href="{{ route('delete.blogmultiple', $item->id) }}" onclick="event.preventDefault(); this.closest('form').submit();">
                                        ...
                                        <div class="modal fade" id="exampleModalCenter{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <h4 class="modal-title" id="exampleModalLongTitle">Edit multiple images</h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                                </div>
                                                <div class="modal-body">
                                                <form action="{{ route('update.blogmultiple') }}" method="POST" enctype="multipart/form-data">
                                                    @csrf 
                                                    <div class="">
