...
{{-- Title --}}
@section('title')
    {{ config('app.name') }} | {{ ucfirst($product->name )}}'s Edit Sizes
@endsection
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="card-text">
                            List of {{ ucfirst($product->name )}}'s Sizes
                        </p>
                                    ...
                                    @foreach ($product->getSizes as $item)
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <form action="{{ route('delete.size', $item->id) }}" method="POST">
                                                            @csrf 
                                                            <a class="dropdown-item" href="{{ route('delete.size', $item->id) }}" onclick="event.preventDefault(); this.closest('form').submit();">
                                        ...
                                        <div class="modal fade" id="exampleModalCenter{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <h4 class="modal-title" id="exampleModalLongTitle">Edit Multiple Image</h4>
                                                ...
                                                <form action="{{ route('update.size') }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <input type="text" value="{{ $item->size }}" name="size" id="size" class="form-control">
                                                        @error('size')
