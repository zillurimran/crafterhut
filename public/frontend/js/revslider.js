            ...
            return this.each(function() {
                ...
                if (!u.hasClass("revslider-initialised")) {
                    ...
                    var b = e.fn.jquery.split("."),
                        ...
                        S = parseFloat(b[2] || "0");
                    if (w == 1 && E < 7) {
                        u.html('<div style="text-align:center; padding:40px 0px; font-size:10px; color:#992222;"> The Current Version of jQuery:' + b + " <br>Please update your jQuery Version to min. 1.7 in Case you wish to use the Revolution Slider Plugin</div>")
                    }
                    if (w > 1) o.ie = false;
