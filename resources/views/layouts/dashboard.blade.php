<!DOCTYPE html>
<html class="loaded light-layout {{ theme(Auth::id())->mode ?? '' }}" lang="en" data-textdirection="ltr">
<!-- BEGIN: Head-->
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard_assets/css/pages/app-user.css') }}">
    ...
    <style>
        .custom-switch.disabled__checkbox .custom-control-label::before,
        .custom-switch.disabled__checkbox .custom-control-label::after,
        .custom-switch.disabled__checkbox .custom-control-label,
        .custom-switch.disabled__checkbox .custom-control-input
        {
            user-select: none;
            pointer-events: none;
        }
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static menu-{{ theme(Auth::id())->nav ?? '' }} " data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <nav class="header-navbar navbar navbar-expand-lg align-items-center floating-nav navbar-light navbar-shadow">
        <div class="navbar-container d-flex content">
            ...
            <ul class="nav navbar-nav align-items-center ml-auto ">
                <li class="nav-item d-none d-lg-block"><a id="dark" class="nav-link nav-link-style"><i class="ficon" data-feather="moon"></i></a></li>
                <li class="nav-item nav-search"><a class="nav-link nav-link-search"><i class="ficon d-none" data-feather="search"></i></a>
                    <div class="search-input">
                        <div class="search-input-icon "><i c data-feather="search"></i></div><input class="form-control input" type="text" placeholder="Enter Text..." tabindex="-1" data-search="search">
                        ...
                        <li class="scrollable-container media-list ps">
                            <a class="d-flex" href="javascript:void(0)">
                                <div class="media d-flex align-items-start">
                                    ...
                                    <div class="media-body">
                                        <p class="media-heading"><span class="font-weight-bolder">Congratulations Sam 🎉</span>winner!</p><small class="notification-text"> I have earned the monthly top sellers badge.</small>
                                    </div>
                                </div>
                            </a>
                            <a class="d-flex" href="javascript:void(0)">
                            ...
                            <a class="d-flex" href="javascript:void(0)">
                                <div class="media d-flex align-items-start">
                                    ...
                                    <div class="media-body">
                                        <p class="media-heading"><span class="font-weight-bolder">Revised order 👋</span>&nbsp;checkout</p><small class="notification-text"> MD Inc. order update.</small>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a class="d-flex" href="javascript:void(0)">
                                <div class="media d-flex align-items-start">
                                    ...
                                    <div class="media-body">
                                        <p class="media-heading"><span class="font-weight-bolder">Server down</span>&nbsp;enregistré</p><small class="notification-text"> US server is down due to high CPU usage.</small>
                                    </div>
                                </div>
                            </a>
                            <a class="d-flex" href="javascript:void(0)">
                                <div class="media d-flex align-items-start">
                                    ...
                                    <div class="media-body">
                                        <p class="media-heading"><span class="font-weight-bolder">Sales report</span>&nbsp;generated</p><small class="notification-text"> Report on last month's sales generated</small>
                                    </div>
                                </div>
                            </a>
                            <a class="d-flex" href="javascript:void(0)">
                                <div class="media d-flex align-items-start">
                                    ...
                                    <div class="media-body">
                                        <p class="media-heading"><span class="font-weight-bolder">High memory</span>&nbsp;use</p><small class="notification-text"> BLR server using high memory</small>
                                    </div>
                                </div>
                            </a>
                ...
                <li class="nav-item dropdown dropdown-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
                        <a class="dropdown-item"  href="{{ route('profile.settings') }}"><i class="mr-50" data-feather="user"></i>Profile</a>
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();
                            this.closest('form').submit();"><i class="mr-50" data-feather="power"></i>Log Out</a>
                        </form>
                    </div>
                </li>
            </ul>
            ...
            <a class="d-flex align-items-center justify-content-between w-100" href="app-file-manager.html">
                <div class="d-flex">
                    ...
                    <div class="search-data">
                        <p class="search-data-title mb-0">Two new items submitted</p>
        ...
        <li class="auto-suggestion">
            <a class="d-flex align-items-center justify-content-between w-100" href="app-file-manager.html">
                <div class="d-flex">
                    ...
                    <div class="search-data">
                        <p class="search-data-title mb-0">52 Generated JPG file</p>
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="nav-item @yield('frontend')">
                    <a target="_blank" class="d-flex align-items-center" href="{{ route('frontend.index') }}">
                        <i data-feather='eye'></i>
                        <span class="menu-title text-truncate" data-i18n="Email">See the website</span>
                    </a>
                </li>
                ...
                <li class="nav-item has-sub" style="">
                    <a class="d-flex align-items-center" href="#">
                        ...
                        <span class="menu-title text-truncate" data-i18n="Invoice">Sub-Categories</span>
                    </a>
                    <ul class="menu-content">
                ...
                <li class="nav-item has-sub" style="">
                    ...
                    <ul class="menu-content">
                        ...
                        {{-- <li class="@yield('productColor')"><a class="d-flex align-items-center" href="{{ route('productColor.add') }}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg><span class="menu-item text-truncate" data-i18n="Add">Colors</span></a> --}}
                        </li>
                    </ul>
                </li>
                @endif
                {{-- <li class="nav-item has-sub" style="">
                    <a class="d-flex align-items-center" href="#">
                        <i data-feather='shopping-cart'></i>
                        <span class="menu-title text-truncate" data-i18n="Invoice">Custom Box</span></a>
                    <ul class="menu-content">
                        <li class="@yield('customBoxIndex')"><a class="d-flex align-items-center" href="{{ route('custom_box.index') }}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg><span class="menu-item text-truncate" data-i18n="List">List</span></a>
                        </li>
                        <li class="@yield('customBoxCreate')"><a class="d-flex align-items-center" href="{{ route('custom_box.create') }}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg><span class="menu-item text-truncate" data-i18n="Add">Create</span></a>
                        </li>
                    </ul>
                </li> --}}
               ...
               @if(permissionCheck(Auth::id(),'Admins') || permissionCheck(Auth::id(),'Users'))
                ...
                <li class="nav-item @yield('admin.index')" style="">
                    <a class="d-flex align-items-center" href="{{ route('admin.index') }}">
                        <i data-feather='users'></i>
                        <span class="menu-title text-truncate" data-i18n="Invoice">Admins</span>
                    </a>
                </li>
                @endif
                {{-- <li class="nav-item @yield('quotes.index')">
                    <a class="d-flex align-items-center" href="{{ route('quotes.index') }}">
                        <i data-feather='circle'></i>
                        <span class="menu-title text-truncate" data-i18n="Chat">Quotes</span>
                    </a>
                </li> --}}
                @if(permissionCheck(Auth::id(),'Blogs') || permissionCheck(Auth::id(),'BlogCategories'))
                <li class="navigation-header">
                ...
                <li class="nav-item has-sub" style="">
                    <a class="d-flex align-items-center" href="#">
                        ...
                        <span class="menu-title text-truncate" data-i18n="Invoice">Faq</span>
                    </a>
                    <ul class="menu-content">
                        <li class="@yield('faqList')"><a class="d-flex align-items-center" href="{{ route('faq.index') }}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg><span class="menu-item text-truncate" data-i18n="List">List</span></a>
                        </li>
                        <li class="@yield('faqCreate')"><a class="d-flex align-items-center" href="{{ route('faq.create') }}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg><span class="menu-item text-truncate" data-i18n="Add">Create</span></a>
                        </li>
                    </ul>
                </li>
                @endif
                ...
                {{--Settings --}}
                <li class="navigation-header">
                    <span data-i18n="Apps &amp; Pages">Parameters</span>
                    <i data-feather="more-horizontal"></i>
                </li>
                ...
                <li class="nav-item has-sub" style="">
                    <a class="d-flex align-items-center" href="#">
                        ...
                        <span class="menu-title text-truncate" data-i18n="Invoice">Collection address</span>
                    </a>
                    <ul class="menu-content">
                        <li class="@yield('addressList')"><a class="d-flex align-items-center" href="{{ route('pickups.index') }}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg><span class="menu-item text-truncate" data-i18n="List">List</span></a>
                        </li>
                    </ul>
                </li>
                @endif
                ...
                <li class="nav-item @yield('contact.index')">
                    <a class="d-flex align-items-center" href="{{ route('contact.index') }}">
                        <i data-feather='message-square'></i>
                        <span class="menu-title text-truncate" data-i18n="Chat">Contact message</span>
                    </a>
                </li>
                @endif
                ...
                <li class="nav-item has-sub" style="">
                    <a class="d-flex align-items-center" href="#">
                        <i data-feather='truck'></i>
                        <span class="menu-title text-truncate" data-i18n="Invoice">Delivery Policy</span>
                    </a>
                    <ul class="menu-content">
                        <li class="@yield('deliveryPolicy.index')"><a class="d-flex align-items-center" href="{{ route('deliveryPolicy.index') }}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg><span class="menu-item text-truncate" data-i18n="List">Add Policy</span></a>
                        </li>
                        <li class="@yield('deliveryPolicy.list')"><a class="d-flex align-items-center" href="{{ route('dliveryPolicy.allPolicies') }}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg><span class="menu-item text-truncate" data-i18n="List">List of policies</span></a>
                        </li>
                    </ul>
                </li>
                @endif
                {{-- <li class="nav-item @yield('deliveryPolicy.index')">
                    <a class="d-flex align-items-center" href="{{ route('deliveryPolicy.index') }}">
                        <i data-feather='compass'></i>
                        <span class="menu-title text-truncate" data-i18n="Chat">Delivery Policy</span>
                    </a>
                </li> --}}
                @if(permissionCheck(Auth::id(),'PaymentNumbers'))
                <li class="nav-item @yield('paymentNumbers.index')">
                    <a class="d-flex align-items-center" href="{{ route('paymentNumbers.index') }}">
                        <i data-feather='compass'></i>
                        <span class="menu-title text-truncate" data-i18n="Chat">Payment Numbers</span>
                    </a>
                </li>
                @endif
                @if(permissionCheck(Auth::id(),'ShippingParameters'))
                <li class="nav-item @yield('shipping.index')">
                    <a class="d-flex align-items-center" href="{{ route('shipping.index') }}">
                        <i data-feather='command'></i>
                        <span class="menu-title text-truncate" data-i18n="Chat">Shipping parameters</span>
                    </a>
                </li>
                @endif
                @if(permissionCheck(Auth::id(),'GeneralSettings'))
                <li class="nav-item @yield('generalSettings')">
                    <a class="d-flex align-items-center" href="{{ route('generalSettings.index') }}">
                        <i data-feather='settings'></i>
                        <span class="menu-title text-truncate" data-i18n="Chat">General parameters</span>
                    </a>
                </li>
                @endif
                ...
                <li class="nav-item @yield('socialiconsettings')">
                    <a class="d-flex align-items-center" href="{{ route('socialIconSettings.index') }}">
                        <i data-feather='users'></i>
                        <span class="menu-title text-truncate" data-i18n="Chat">Social icon settings</span>
                    </a>
                </li>
                @endif
                <!-- Socials Icons Settings-->
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0">
            <span class="float-md-left d-block d-md-inline-block mt-25">COPYRIGHT &copy; 2023
