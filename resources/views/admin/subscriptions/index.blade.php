                            ...
                            <table id="data_table" class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="font-weight-bold">{{ $subscription->email }}</span>
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <form action="{{ route('subscriptions.destroy', $subscription->id) }}" method="POST">
                                                        ...
                                                        {{ method_field('DELETE') }}
                                                        @csrf 
                                                        <a class="dropdown-item" href="{{ route('subscriptions.destroy', $subscription->id) }}" onclick="event.preventDefault(); this.closest('form').submit();">
